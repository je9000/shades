...
public:
    ...
    Networking(NetDriver &nd, const IPv4AddressAndMask my_address_and_mask) :
        net_driver(nd),
        net_in(nd),
        promiscuous(false),
        ipv4_layer(*this),
    ...
    bool ethernet_callback(NetworkingInput &, PacketHeader &p1, PacketHeader &pN, void *) {
    ...
    bool ipv4_callback(NetworkingInput &, PacketHeader &p1, PacketHeader &pN, void *) {
    ...
    bool icmp_echo_callback(NetworkingInput &, PacketHeader &p1, PacketHeader &pN, void *) {
    ...
    NetworkingInput &input() { return net_in; }
